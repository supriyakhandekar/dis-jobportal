...
class MainPage extends Component {
  ...
  addTemplates(obj) {
    ...
    this.setState({templates : template_list.concat(obj)});

  }

  addTemplateNames(name) {
    var template_names = this.state.template_names;
    this.setState({template_names : template_names.concat(name)});
    alert(this.state.template_names);
  }
    ...
    switch(step_number) {
      ...
      case 2:
        return <Step2 addTemplates = {this.addTemplates.bind(this)}
                      template_objs = {this.state.templates}
                      addTemplateNames = {this.addTemplateNames.bind(this)}/>
      case 3:
        alert(this.state.bagItems);
